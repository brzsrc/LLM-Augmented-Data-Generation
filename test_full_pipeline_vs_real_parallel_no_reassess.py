...
def run_parallel_pipeline(real_df, ext, llm, n_runs, with_reflection,
    ...
    for k in range(max_steps):
        ...
        for uid in active_uids:
            ...
            obs_text = rt.stream.format_memories(rt.stream.get_recent(n=20, mem_type='observation'))
            ref_text = rt.stream.format_memories(rt.stream.get_recent(n=3, mem_type='reflection'))
